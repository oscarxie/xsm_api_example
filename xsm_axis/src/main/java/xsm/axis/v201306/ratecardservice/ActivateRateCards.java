 ...
 *
 * Tags: RateCardService.activateRateCards
 *
 * @author Oscar Xie
 */
public class ActivateRateCards {
  ...
  public static void runExample(DfpServices dfpServices, DfpSession session, long ratecardId)
    ...
    do {
      ...
      if (page.getResults() != null) {
        ...
        for (RateCard rateCard : page.getResults()) {
          System.out.printf(
              "%d) Rate Card with ID \"%d\" will be activated.\n", i++, rateCard.getId());
        }
      }
    ...
    System.out.printf("Number of rate cards to be activated: %d\n", totalResultSetSize);
    ...
    if (totalResultSetSize > 0) {
      ...
      // Create action.
      com.google.api.ads.dfp.axis.v201306.ActivateRateCards action =
          new com.google.api.ads.dfp.axis.v201306.ActivateRateCards();
      ...
      if (result != null && result.getNumChanges() > 0) {
        System.out.printf("Number of rate cards activated: %d\n", result.getNumChanges());
      } else {
        System.out.println("No rate cards were activated.");
      }
    }
  }
